import './mapPatches.js';

sc.OPTIONS_DEFINITION['voice-tracks'] = {
  ...
  .defines(function () {
    ig.merge(ig.BGM_TRACK_LIST, {
      ...
      jungle: {
        ...
        loopEnd: 108.113,
        volume: 0.7,
        introPath: 'media/bgm/garden-i.mp3',
        introEnd: 17.348,
      },
      emilie: {
      ...
      jungleFish: {
        path: 'media/bgm/AnglerFish.mp3',
        loopEnd: 75.098,
        volume: 0.5,
        introPath: 'media/bgm/AnglerFish-i.mp3',
        introEnd: 10.106,
      },
      panzaMK2: {
        path: 'media/bgm/PandzaMkII.mp3',
        loopEnd: 158.077,
        volume: 0.5,
        introPath: 'media/bgm/PandzaMkII-i.mp3',
        introEnd: 18.402,
      },
      pengDakara: {
